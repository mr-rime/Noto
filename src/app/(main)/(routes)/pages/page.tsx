    ...
    return (
        <div className="w-full ml-[var(--sidebar-width,300px)] min-h-screen bg-white">
            <div className="max-w-[860px] mx-auto px-10 pt-20 pb-16">
                ...
                <div className="mb-10">
                    <h1 className="text-[32px] font-bold text-[#37352F] leading-tight">
                ...
                {recentPages.length > 0 ? (
                    <section>
                        <div className="flex items-center justify-between mb-4">
                            <h2 className="text-[12px] font-semibold text-[#9B9A97] uppercase tracking-wider">
                                Recently updated
                            </h2>
                        </div>
                    ...
                    <div className="flex flex-col items-center justify-center py-24 text-center">
                        ...
                        <p className="text-[16px] font-medium text-[#37352F]">No pages yet</p>
